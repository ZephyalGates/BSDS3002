...
df = pd.read_parquet(r"Z:\BSDS3002_GP_GIT\BSDS3002\legacy\data_similarity_larger_than_93_with_id.parquet")
...
df_elements = set(df['Spotify Name'].values.flatten())
...
print("Elements not included in the DataFrame columns with a fuzzy matching similarity of at least 90%:")
print(not_included)